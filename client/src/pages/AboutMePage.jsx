  ...
  return (
    <div className="custom-page">
      ...
      <Container className="info-card-container">
        <Row>
          <Col sm={12}>
            <InfoCard headerText="Computer Enthusiast" text={computerEnthusiastText} imagePath="TEST/IMAGE/PATH.JPG"/>
          </Col>
        </Row>
        
        <Row>
          <Col sm={12}>
            <InfoCard headerText="Education" text={educationText} imagePath="ANOTHER/IMAGE/PATH.PNG" alignImageRight={true}/>
          </Col>
        </Row>
